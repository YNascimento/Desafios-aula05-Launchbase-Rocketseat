...
module.exports = {
    index(req,res){
        ...
        limit = limit || 2 //limit of row per page
        
        let offset = limit*(page-1) //offset of shown rows per page
        ...
        const params = {
            ...
            callback(teachers){
                let pagination = {}
                pagination = {
                    total: Math.ceil(teachers[0].total / limit),  //uses total of instructors to get total of pages dividing it per limit
                    page
                }
